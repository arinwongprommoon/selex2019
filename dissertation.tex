...
Nucleosome positioning defines where nucleosomes are positioned within the genome. \cite{struhl_determinants_2013} % citation: Struhl and Segal, 2013. Will take care of citations later.
...
Segal \emph{et al.} (2006) % is there a way to do this without manually typing this?
