...
Methylation in clusters disfavours nucleosome positioning \emph{in vivo}. This is because densely methylated DNA is rigid and does not favour the curvature needed to form nucleosomes.
...
Methylation of DNA in the algae \emph{Ostreococcus lucimarinus} and \emph{Micromonas pusilla} occurs periodically in the linker DNA between nucleosome, and is almost completely excluded from nucleosome cores.  This is based on micrococcal nuclease digestion (\cite{huff_dnmt1-independent_2014}).  For these organisms, up to half the cytosines in CpG islands within the regions of methylation are methylated.  The coccolithophore \emph{Emiliania huxleyi} has lower rates of CpG methylation, but exhibits CHG methylation at a periodicity similar to that of CpG methylation to compensate. This gives a rate of methylation close to that of other species.

Additionally, dense methylation itself contributes directly to the positioning of nucleosomes.  This is supported by nucleosome mapping on fully methylated \emph{O. lucimarius} DNA: nucleosomes are preferentially positioned on sequences that are non methylated \emph{in vivo}.

% Genome-wide mapping of nucleosome positioning and DNA methylation within individual DNA molecules (Kelly et al, 2012)

In sum, if you want nucleosomes to form around your DNA, you must make it able to curve around your DNA.  Certain dinucleotides help with this if they're positioned with a 10 bp periodicity.  In contrast, poly(dA:dT) tracts, poly(dC:dG) tracts, and CpG methylation makes DNA stiff and therefore nucleosomes don't form at these regions.  Because of this, organisms exploit these sequences to get their nucleosomes at places they should be e.g. away from transcription start sites.
