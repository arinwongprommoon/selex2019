...
Nucleosome positioning defines where nucleosomes are positioned within the genome. % citation: Struhl and Segal, 2013. Will take care of citations later.
...
Along with other factors such as ATP-dependent nucleosome modelling enzymes and transcription factors, the DNA sequence contributes to nucleosome positioning.

For the most part, this is due to nucleotide sequences affecting flexibility of the DNA around histone octamers.  The dinucleotide sequences AT and TA confer high `bendability' if they are situated on the face of the helical repeat that directly interacts with the histone octamer.  Non-homopolymeric (G+C)-rich sequences also promote nucleosome formation.  In contrast, the homopolymeric sequences poly(dA:dT) and poly(dG:dC) confer stiff structures that inhibit nucleosome formation.

Methylation affects nucleosome positioning.
