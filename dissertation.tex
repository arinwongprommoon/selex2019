...
% I guess the novelty here is SELEX? Like why the hell are we using SELEX to do this as opposed to the other methods people have been using? What kind of new conclusion or achievement are we getting from this, especially if study after study confirm existing `rules' about nucleosome positioning?
