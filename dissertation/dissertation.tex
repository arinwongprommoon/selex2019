...
\begin{titlepage}
  ...
  {\large \today\par}
  \vfill
  This dissertation contains 4,814 words, excluding the bibliography, figures, figure legends, tables, table headings, abbrevations, acknowledgements, and tables of contents.
  \end{titlepage}

  % Note to state which experiments were carried out on behalf of the student
Preparation for next-generation DNA sequencing, the sequencing itself, and demultiplexing was carried out by the day-to-day supervisor on behalf of the student.  All other experiments were carried out by the student.
