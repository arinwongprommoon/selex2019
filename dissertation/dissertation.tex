...
% Might end up just including one of the four just to make my point that the bottleneck effect doesn't introduce a lot of bias
\begin{figure}[htb]
  \centering
  \begin{subfigure}[htb]{0.5\textwidth}
    \centering
...
%% REWRITE ENTIRE THING, and add bottleneck
