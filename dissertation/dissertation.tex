...
% problem, approaches (in outline), major findings. make main points absolutely clear. aim for 200-250 words
  ...
  Nucleosome positioning in eukaryotes have certain sequence preferences as certain sequences confer physicial flexibility to DNA so that the DNA can wrap around histone octamers.  Previous research based on micrococcal nuclease digests has identified AA, AT, and TA occurring at a periodicity of approximately 10 bp, GC occurring out of phase, and poly(dA:dT) tracts disfavouring nucleosome positioning.  Additionally, there has also been evidence that CpG methylation disfavours nucleosome positioning, but \emph{in vitro} sequence data for this is not available.  Furthermore, the effects of CH methylation have not been characterised.  Nucleosome EMSA-SELEX is a method that selects for oligonucleotides that have affinity for histone octamers, and the first part of the project used this technique to study the sequence specificity of the nucleosome on methylated and non-methylated DNA.  Existing rules regarding nucleosome positioning on unmethylated DNA were confirmed.  Furthermore, cytosine methylation was found to align the phases of dinucleotides harbouring cytosines compared to unmethylated DNA.  Finally, CpG-methylated and half-C-methylated DNA containing A/T-rich nucleotide 9-mers were found to disfavour nucleosome positioning.

  However, all-C-methylated DNA bound in nucleosomes and not bound in nucleosomes exhibited similar sequence biases, which would most likely be explained by PCR bias.  PCRis the main source of bias in massively parallel sequencing.  Most notably, PCR severely depletes DNA with GC content lower than 12\% or higher than 65\%.  Although it is known that the choice of polymerase enzymes can mitigate PCR bias, the biases introduced from the number of PCR cycles and from DNA purification have not been characterised.  The second part of the project aimed to test sequence biases introduced by various aspects of PCR.  The commercial DNA polymerases DreamTaq, Phusion, Phire, and Q5 were found to exhibit weak biases towards A and T, with Phusion exhibiting the least bias and Phire the greatest.  The bottleneck effect was found not to introduce bias to the same degree.  Furthermore, purification by AMPure beads and the vendors for DNA polymerase and dNTPs were found to introduce minimal sequence biases.  With the development of an improved input library with adequate filtering of sequences, such information would pave the way for the development of an explicit model for PCR bias as a function of the number of PCR cycles.
