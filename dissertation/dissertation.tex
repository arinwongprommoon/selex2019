...
\begin{figure}[htpb]
  ...
  \end{subfigure}
  \caption{Effects of cytosine methylation: radial plots showing amplitude and phase}
  \label{fig:radial_mc}
\end{figure}
...
When the cytosines were methylated, the amplitude for dinucleotides beginning with C increased, and their phases became more aligned (figure~\ref{fig:radial_mc}). % topic sentence
