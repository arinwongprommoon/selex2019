...
mydata <- data.frame(normcnt$kmer, xcnt_norm$xcnt.counts.normcnt.counts, ycnt_norm$ycnt.counts.normcnt.counts, kmercolours)
colnames(mydata) <- c("kmer", "x_normcounts", "y_normcounts", "kmer_colour")
